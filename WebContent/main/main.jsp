  ...
  System.out.println("room : "+room);%>
    <div id="intro">
    	<div class="main_content">
    		<img class="main_pet" alt="" src="../resources/image/main.jpg">
    		<div>
    ...
    <div id="about">
    	<div class="main_content" >
    		...
    		<img class="main_pet" alt="" src="../resources/image/about.png">
    	</div>
    </div>
    <div id="service">
