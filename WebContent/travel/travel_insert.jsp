...
<body>
	...
	<jsp:useBean id="dto" class="com.pet.ft.dto.TravelDto" scope="request"></jsp:useBean>
	<div class="travel_container">
		...
		<div class="travel_box">
			...
			<form action="pet.do" method="post">
				<input type="hidden" name="command" value="travelInsert" />
				<input type="hidden" name="member_no" value="<jsp:getProperty property="member_no" name="dto"/>"/>
				<div class="travel_box_text">
					<ul class="text_wrap">
						<li>
							<dl>
								<dt>제목/날짜</dt>
								<dd><input type="text" name="travel_name">
									<input class="travel_date" type="text" value="yyyymmdd" name="travel_date">
								</dd>
							</dl>
						...
						<li>
							<dl>
								<dt>1.출발지</dt>
								<dd>
									<input type="text" name="travel_spot1" />
								</dd>
							</dl>
							<br>
							<dl>
								<dt>- 이동시간</dt>
								<dd>
									<input type="text" name="travel_time1"> ex)35분 ->35
								</dd>
							</dl>
						</li>
						<li>
							<dl>
								<dt>2.중간 장소</dt>
								<dd>
									<input type="text" name="travel_spot2" />
								</dd>
							</dl>
							<br>
							<dl>
								<dt>- 머무는 시간</dt>
								<dd>
									<input type="text" name="travel_stay1" />
								</dd>
							</dl>
							<br>
							<dl>
								<dt>- 이동시간</dt>
								<dd>
									<input type="text" name="travel_time2" />
								</dd>
							</dl>
						...
						<li>
							<dl>
								<dt>3.도착지</dt>
								<dd>
									<input type="text" name="travel_spot3" />
								</dd>
							</dl>
							<br>
							<dl>
