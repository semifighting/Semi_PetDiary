		...
		<div id="community_search">
			...
			<form action="/semi_PetDiary/pet.do?" method="post">			
				...
				<select class="filter" name="filter">
					...
					<option <%if("content".equals(filter)){%>selected <%}%> value="content"> 내용</option>
					<option <%if("comment_content".equals(filter)){%>selected <%}%> value="comment_content"> 댓글내용</option>
				</select>			
				<input type="text"class="search_content" name="search_content"value="<%=request.getParameter("search_content")%>"/>
