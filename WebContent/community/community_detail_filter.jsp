<%@page import="com.pet.ft.controller.pet_filter"%>
	...
	<div id="community_detail_fullbox">
		<div id ="community_detail_contentbox">
			...
			<div id="community_detail_title">
				<%=pet_filter.maTest(cdto.getCommunity_title()) %>
			</div>	
			...
			<div id="community_detail_content">
				<%=pet_filter.maTest(cdto.getCommunity_content()) %>
			</div>
		</div>
		<%if(session.getAttribute("member_no")!=null) {%>
		...
		%>		
			<div style="  border-bottom: 1px solid #bbb;margin-bottom: 10px; padding-bottom: 20px;">
				...
				<div class="content"><%=pet_filter.maTest(commentdto.getCommunity_content()) %></div>
