...
<div id="myinfo_list">
	...
	<div class="container">
		...
		<div class="myinfo_content" onclick="location.href='..y/pet.do?command=MyCommunityList'">
		...
		<div class="myinfo_content" onclick="location.href='../paging.do?command=book'">
		...
		<div class="myinfo_content" onclick="location.href='../pet.do?command=picture_m0ain'">
