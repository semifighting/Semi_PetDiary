...
%>				
			<td id="dates">
				<a class="date" style="color:<%=color%>; cursor: pointer" onclick="location.href='../pet.do?command=calendar_calInsert&year=<%=year%>&month=<%=month%>&date=<%=d%>&lastday=<%=lastDay %>'"><%=d%></a>
				<div>
