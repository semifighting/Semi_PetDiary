...
public class CalendarDto {
    ...
    public CalendarDto(int calendar_no, String calendar_startdate, String calendar_enddate, String calendar_necessity, String calendar_item, String calendar_title, String calendar_content, int member_no) {
        this.calendar_no = calendar_no;
        this.calendar_startdate = calendar_startdate;
        this.calendar_enddate = calendar_enddate;
        this.calendar_necessity = calendar_necessity;
