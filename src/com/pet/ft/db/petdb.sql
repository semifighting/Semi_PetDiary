SELECT * FROM COMMUNITY WHERE COMMUNITY_NO IN (SELECT COMMUNITY_NO FROM COMMUNITY WHERE COMMUNITY_COMMENT >0 AND DBMS_LOB.INSTR(COMMUNITY_CONTENT, '고양이')>0) AND COMMUNITY_REPORT='N'
