		...
		SELECT COUNT(BUSINESS_NUM) FROM BUSINESS;
...
SELECT B.RNUM, B.BUSINESS_NUM, B.BUSINESS_NAME, B.BUSINESS_ADDR, B.BUSINESS_ROLE, B.MEMBER_PHONE, B.BUSINESS_PARK
		FROM(
			SELECT ROWNUM AS RNUM, A.BUSINESS_NUM, A.BUSINESS_NAME, A.BUSINESS_ADDR, A.BUSINESS_ROLE, A.MEMBER_PHONE, A.BUSINESS_PARK
			FROM(
					SELECT BUSINESS_NUM, BUSINESS_NAME, BUSINESS_ADDR, BUSINESS_ROLE, MEMBER_PHONE, BUSINESS_PARK
					FROM BUSINESS JOIN MEMBER USING(MEMBER_NO)
					WHERE BUSINESS_ROLE = 'S'
					ORDER BY BUSINESS_NUM DESC) A)B;
-------------MEMBER
