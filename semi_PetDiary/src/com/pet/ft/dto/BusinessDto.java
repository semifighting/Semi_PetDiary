...
public class BusinessDto {
	...
	private int business_member_no;
	...
	public BusinessDto(int business_num, String business_name, String business_addr, String business_role,
		...
		this.business_member_no = business_member_no;
	}
	...
	public int getBusiness_member_no() {
		return business_member_no;
	}

	public void setBusiness_member_no(int business_member_no) {
		this.business_member_no = business_member_no;
	}
